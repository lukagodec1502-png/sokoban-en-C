...
* **Logique de déplacement :** Implémentation des déplacements du personnage (Haut, Bas, Gauche, Droite) via les entrées utilisateur.
...
# Lancer le jeu avec une carte de test
./sokoban map.txt
